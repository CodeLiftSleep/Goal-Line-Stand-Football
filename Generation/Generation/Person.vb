...
"Perfectionist int NULL, Polished int NULL, Private int NULL, Resourceful int NULL, SelfDoubting int NULL, SelfSufficient int NULL, StrongWilled int NULL, Stubborn int NULL, TeamPlayer int NULL, Tense int NULL, Vigilant int NULL"
    ...
    Public Sub GetPersonalityStats(ByVal DT As DataTable, ByVal PersonNum As Integer, ByVal ClassInstance As Object)
    ...
    Private Sub PutDataInDT(ByVal DT As DataTable, ByVal file As StreamReader)
        ...
        End Using
    End Sub
    Private Function GetItem(ByVal MyItem As DataTable, ByVal DTOutPutTo As DataTable) As String
    ...
    Private Function GetWeight(ByVal Height As Integer, Optional ByVal Pos As String = "") As Integer
        Dim result As Integer
        Select Case Pos
    ...
    Private Function GetHeight(Optional ByVal Pos As String = "") As Integer
        Dim result As Integer
        Select Case Pos
            Case "QB"
