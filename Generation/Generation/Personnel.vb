...
TeamBuilding varchar(20) NULL, RespectedByPlayers int NULL, RespectedByCoaches int NULL, RespectedByScouts int NULL, OrganizationalPower int NULL, " + MyPerson.SQLString
...
DevLB int NULL, DevCB int NULL, DevSF int NULL, LowerBodyTrain int NULL, UpperBodyTrain int NULL, CoreTrain int NULL, PreventInjuryTrain int NULL, StaminaTrain int NULL, " + MyPerson.SQLString
        End Select
        Return result
    End Function
