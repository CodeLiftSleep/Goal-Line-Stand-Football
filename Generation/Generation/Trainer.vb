...
TreatHipInj int NULL, TreatQuadInj int NULL, TreatHamstringInj int NULL, TreatCalfInj int NULL, TreatAnkleInj int NULL, TreatFootInj int NULL, TreatKneeInj int NULL, TreatSpinalInj int NULL, DiagnoseInj int NULL, SurgicallyRepair int NULL, " + MyPerson.SQLString
    Sub New()
